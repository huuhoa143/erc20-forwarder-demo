...
exports.ensureFile = async (pathFile) => new Promise((resolve, reject) => {
  fs.ensureFile(pathFile, (error) => {
    if (error) return reject(error);
...
exports.checkAndCreateDirectory = async (dir) => new Promise((resolve, reject) => {
